Le jeu du Pendu est un jeu classique de devinette dans lequel un joueur doit trouver un mot en proposant des lettres, une à une, dans une limite de tentatives définie.
